		...
		<section id="one" class="wrapper style1 special">
			<div class="inner">
				...
				<form action="#one" method="post">
					<p>Choose your birthday date: <input type="text" id="datepicker" name="datepicker"><span class="message<?php if (isset($_POST['datepicker']) && ($_POST['datepicker'] == null)) echo ' alert'; ?>">Please choose your birthday date</span></p>
				...
				if ($is_date) {
					//insert functions
					require_once('src/controller/functions.php');
